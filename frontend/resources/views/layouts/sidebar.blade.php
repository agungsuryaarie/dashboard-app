         ...
         <ul class="scrollable__content py-2">
             ...
             <li>
                 <a href="javascript:;" class="menu">
                     ...
                     <div class="menu__title"> Perizinan <i data-lucide="chevron-down" class="menu__sub-icon "></i>
                     </div>
                 </a>
                 <ul class="">
                     <li>
             ...
             <li>
                 <a href="javascript:;" class="menu">
                     ...
                     <div class="menu__title"> Pajak <i data-lucide="chevron-down" class="menu__sub-icon "></i>
                     </div>
                 </a>
                 <ul class="">
                     <li>
             ...
             <li>
                 <a href="javascript:;" class="menu">
                     ...
                     <div class="menu__title"> Stunting <i data-lucide="chevron-down" class="menu__sub-icon "></i>
                     </div>
                 </a>
                 <ul class="">
                     <li>
             ...
             <li>
                 <a href="javascript:;" class="menu">
                     ...
                     <div class="menu__title"> PKK <i data-lucide="chevron-down" class="menu__sub-icon "></i>
                     </div>
                 </a>
                 <ul class="">
                     <li>
             ...
             <li>
                 <a href="javascript:;" class="menu">
                     <div class="menu__icon"> <i data-lucide="Layers"></i> </div>
                     <div class="menu__title"> Sibisa <i data-lucide="chevron-down" class="menu__sub-icon "></i>
                     </div>
                 </a>
                 <ul class="">
                     <li>
