<x-app-layout>
    <div class="grid grid-cols-12 gap-6">
        <div class="col-span-12">
            <x-profile-bapenda></x-profile-bapenda>
            <div class="grid grid-cols-12 gap-6">
                ...
                <div class="col-span-12 mt-8">
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <x-card1>
                            ...
                            <div class="font-semibold text-xs mt-2">REALISASI HARI INI</div>
                            <div class="text-slate-700 text-sm mt-0.5">14.211.500</div>
                            <div class="font-semibold  text-xs mt-2">REALISASI SAMPAI HARI INI</div>
