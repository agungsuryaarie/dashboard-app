                                                ...
                                                <div class="intro-y flex items-center h-10">
                                                    ...
                                                    <a href="{{ route('sibisa') }}"
                                                        class="ml-auto flex items-center text-primary"> <svg
                                                            ...
                                                            icon-name="refresh-ccw" data-lucide="refresh-ccw"
                                                    ...
                                                    <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                                        <div class="report-box zoom-in">
                                                            <div class="box p-5">
                                                                ...
                                                                <div class="text-3xl font-medium leading-8 mt-6">
                                                                    {{ $kelurahan }}</div>
                                                                <div class="text-base text-slate-500 mt-1">Desa/Kelurahan
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                                        <div class="report-box zoom-in">
                                                            <div class="box p-5">
                                                                ...
                                                                <div class="text-3xl font-medium leading-8 mt-6">152.040
                                                                </div>
                                                                <div class="text-base text-slate-500 mt-1">Unique Visitor
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="intro-y">
                                                        <div class="box px-8 py-8 mb-3 flex items-center zoom-in">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="44"
                                                                ...
                                                                class="lucide lucide-users report-box__icon text-primary">
                                                            ...
                                                            <div class="ml-4 mr-auto">
                                                                ...
                                                                <div class="text-slate-500 text-xs mt-0.5">Total Population
                                                                </div>
                                                            </div>
                                                            <div
                                                    ...
                                                    <div class="intro-y">
                                                        <div class="box px-8 py-8 mb-3 flex items-center zoom-in">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="36"
                                                                ...
                                                                stroke="currentColor" stroke-width="2"
                                                                stroke-linecap="round" stroke-linejoin="round"
                                                                icon-name="archive" data-lucide="archive"
